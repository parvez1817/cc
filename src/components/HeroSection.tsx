      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto animate-slide-in-up">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Explore centuries of heritage, monuments, festivals, and stories 
            in a fully immersive VR experience. Where ancient wisdom meets cutting-edge technology.
          </p>
