      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Preserving Culture through VR. Experience India's magnificent heritage 
              through immersive virtual reality technology that brings history to life.
            </p>
        ...
        <div className="border-t border-border pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 sm:mb-0">
            © 2024 Cultural Chronicles. All rights reserved. Preserving culture through technology.
          </p>
