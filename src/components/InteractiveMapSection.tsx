      ...
      <div ref={ref} className={`container mx-auto px-4 sm:px-6 lg:px-8 ${isVisible ? 'animate-on-scroll' : ''}`}>
        ...
        <div className="text-center mb-16 animate-slide-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair font-bold mb-6">
            ...
            <br />
            <span className="text-foreground">One State at a Time</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Click on any state to experience its unique heritage — virtually walk through temples 
            of Tamil Nadu or witness Rajasthan's vibrant festivals.
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-muted-foreground mb-6">
            Ready to explore all 28 states and 8 union territories?
          </p>
